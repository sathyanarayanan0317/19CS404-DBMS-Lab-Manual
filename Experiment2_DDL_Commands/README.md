...
(b) MODIFY
```sql
ALTER TABLE relation_name MODIFY (field_1 ne[# Experiment 2: DDL Commands
...
](https://github.com/sathyanarayanan0317/19CS404-DBMS-Lab-Manual/blob/main/Experiment1_ER_Diagram/problem_statement.md)w_data_type(size));
```
(c) DROP
```sql
ALTER TABLE relation_name DROP COLUMN field_name;
